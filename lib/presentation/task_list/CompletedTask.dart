...
class CompletedTask extends StatefulWidget{
  ...
  CompletedTask(this.taskViewModel,{Key key, this.title}) : super(key: key);
  final String title;

  @override
  _CompletedTask createState() => _CompletedTask(taskViewModel);
}

class _CompletedTask extends State<CompletedTask> {
  final TaskViewModel taskViewModel;

  _CompletedTask(this.taskViewModel);
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<Task>>(
        stream: taskViewModel.taskCompletedList,
